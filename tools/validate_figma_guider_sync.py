...
def main() -> None:
    ...
    if args.baseline_project:
        ...
        # GUI Guider updates this volatile timestamp on every successful save.
        # It is roundtrip evidence, not a project-configuration change.
        baseline_non_screen.pop("lastModified", None)
        candidate_non_screen.pop("lastModified", None)
