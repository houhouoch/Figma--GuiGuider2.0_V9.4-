...
- `evidence/v9/`：V9 受控同步的机器可读与人工审核证据。

历史复盘保留了原始 Windows 路径，作为当时操作和验证的证据。当前公开仓库的实际入口以根目录 `README.md` 和 `project/` 为准。
...
- `evidence/v9/`: machine-readable and reviewed V9 evidence.

Historical documents intentionally preserve original Windows paths as evidence. Use the root README and `project/` as the entry points for the public repository.
